...
for winner in vincitori:
    ...
    for book in soup.find_all('div', class_='colio-main'):
        ...
        title = book.find('span', class_='book-title')

        publisher = book.find('span', class_='book-editor')
    ...
    with open('ps_nominees_2019-2021.json', 'w', encoding='utf-8') as outfile2:
